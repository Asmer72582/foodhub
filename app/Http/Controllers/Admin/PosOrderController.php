...
class PosOrderController extends AdminController
{
    ...
    public function changePaymentMethod(
        ...
        try {
            return new OrderDetailsResource($this->orderService->changePaymentMethod($order, $request));
        } catch (Exception $exception) {
            return response(['status' => false, 'message' => $exception->getMessage()], 422);
        }
    }
    ...
    public function changeOrderMethod(
        ...
        try {
            return new OrderDetailsResource($this->orderService->changeOrderMethod($order, $request));
        } catch (Exception $exception) {
            return response(['status' => false, 'message' => $exception->getMessage()], 422);
        }
    }
