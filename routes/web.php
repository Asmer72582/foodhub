...
Route::get('/mail-debug', function () {
    return [
        'env' => env('MAIL_PORT'),
        'config' => config('mail.mailers.smtp.port'),
        'type' => gettype(config('mail.mailers.smtp.port')),
    ];
});
...
Route::get('/env-debug', function () {
    return [
        'APP_NAME (env)' => env('APP_NAME'),
        'DB_DATABASE (env)' => env('DB_DATABASE'),
        'SESSION_LIFETIME (env)' => env('SESSION_LIFETIME'),
        'SESSION_LIFETIME (config)' => config('session.lifetime'),
        'Type' => gettype(config('session.lifetime')),
    ];
});
