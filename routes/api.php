...
Route::middleware(['auth:sanctum'])->group(function () {
    // POS Order routes
    Route::put('admin/pos-order/{order}', [App\Http\Controllers\Admin\PosOrderController::class, 'update'])
        ->middleware('permission:pos-orders');

    Route::post('admin/pos-order/change-order-method/{order}', [App\Http\Controllers\Admin\PosOrderController::class, 'changeOrderMethod'])
        ->middleware('permission:pos-orders');
});

Route::prefix('admin')->name('admin.')->middleware(['installed', 'localization', 'auth:sanctum'])->group(function () {
    Route::post('item/sort', [App\Http\Controllers\Admin\ItemController::class, 'sortItem'])->middleware('permission:items_edit');
    ...
    Route::prefix('employee')->name('employee.')->group(function () {
        Route::get('/pos-list', [EmployeeController::class, 'posList']);
    ...
    Route::prefix('item')->name('item.')->group(function () {
        ...
        Route::post('/sort', [ItemController::class, 'sortItem']);
    ...
    Route::prefix('pos-order')->name('posOrder.')->group(function () {
        ...
        Route::get('edit/{order}', [PosOrderController::class, 'edit']);
        Route::post('{order}', [PosOrderController::class, 'update']);
        ...
        Route::post('/change-order-method/{order}', [PosOrderController::class, 'changeOrderMethod']);
    });
    ...
    Route::prefix('chef')->name('chef.')->group(function () {
        ...
        Route::get('/kanban', [ChefController::class, 'kanban']);
        Route::post('/order-status/{order}', [ChefController::class, 'changeOrderStatus']);
    ...
    Route::prefix('dashboard')->name('dashboard.')->middleware(['auth:sanctum'])->group(function () {
        ...
        Route::get('/total-tips', [DashboardController::class, 'totalTips']);
        ...
        Route::get('/employee-orders', [DashboardController::class, 'employeeOrders']);
...
Route::prefix('table')->name('table.')->middleware(['installed', 'localization'])->group(function () {
