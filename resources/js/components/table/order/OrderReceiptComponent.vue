        ...
        <div class="modal-dialog max-w-[340px] rounded-none" id="print" :dir="direction">
            <div class="modal-body">
                <div class="text-center pb-3.5 border-b border-dashed border-gray-400">
                    ...
                    <h5 v-if="orderBranch.email" class="text-sm font-normal">Email: {{ orderBranch.email }}</h5>
                    <h5 v-if="setting.company_website" class="text-sm font-normal">{{ setting.company_website }}</h5>
                </div>
