    ...
    <section class="pt-8 pb-16">
        ...
        <div v-if="demo === 'true' || demo === 'TRUE' || demo === 'True' || demo === '1' || demo === 1"
            ...
            <nav class="flex justify-center">
                <button @click.prevent="setupCredit('trial')"
                    class="click-to-prop w-full h-10 leading-10 rounded-lg text-center text-sm capitalize text-white bg-red-500"
                    id="trialClick">
                    Free Trial
                </button>
            </nav>
    ...
    methods: {
        ...
        setupCredit: function (e) {
            if (e === 'admin') {
                ...
                this.form.email = 'trial@foodhub.com';
                this.form.password = '123456';
            }
        }
    }
