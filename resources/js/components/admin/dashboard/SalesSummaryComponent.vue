        ...
        <div class="db-card">
            ...
            <div class="db-card-body">
                <ul class="flex gap-11">
                    ...
                    <li>
                        <div class="flex items-center gap-2.5">
                            <i class="lab lab-total-menu-items lab-font-size-20 text-[#A953FF]"></i>
                            <h3 class="font-bold text-[22px] leading-[34px]">{{ total_tips }}</h3>
                        </div>
                        <p class="text-xs capitalize">Total Tips</p>
                    </li>
                </ul>
            ...
            this.$store.dispatch("dashboard/salesSummary", date).then((res) => {
                ...
                this.options = {
                    series: [
                        ...
                        {
                            name: this.$t('label.total_tips'),
                            data: res.data.data.per_day_tips,
                        }
                    ],
                    chart: {
                        type: 'area',
