<template>
    ...
    <div class="row">
        ...
        <DashboardPaymentBreakdownComponent/>
        <!--========PAYMENT BREAKDOWN END=============-->

        <!--========ORDER BREAKDOWN START=============-->
        <DashboardOrderBreakdownComponent/>
        <!--========ORDER BREAKDOWN END=============-->

        <!--========PAYMENT METHOD BREAKDOWN START=============-->
        <DashboardPaymentMethodBreakdownComponent/>
        <!--========PAYMENT METHOD BREAKDOWN END=============-->
...
import EmployeeOrdersComponent from "./EmployeeOrdersComponent";
...
import DashboardPaymentBreakdownComponent from "./DashboardPaymentBreakdownComponent";
import DashboardOrderBreakdownComponent from "./DashboardOrderBreakdownComponent";
import DashboardPaymentMethodBreakdownComponent from "./DashboardPaymentMethodBreakdownComponent";
