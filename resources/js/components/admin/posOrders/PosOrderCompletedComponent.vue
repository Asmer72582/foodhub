    ...
    <div class="col-12">
        <div class="db-card">
            <div class="db-card-header border-none">
                <h3 class="db-card-title">{{ $t('menu.pos_orders_completed') }}</h3>
...
export default {
    name: "PosOrderCompletedComponent",
    components: {
        TableLimitComponent,
        PaginationSMBox,
        PaginationBox,
    ...
    data() {
        return {
            ...
            printObj: {
                id: "print",
                popTitle: this.$t("menu.pos_orders_completed"),
            },
            props: {
                form: {
                    date: null,
    ...
    methods: {
        ...
        xls: function () {
            ...
            this.$store.dispatch("posOrder/export", this.props.search).then((res) => {
                ...
                link.download = this.$t("menu.pos_orders_completed");
                link.click();
