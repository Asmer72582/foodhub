                        ...
                        <div class="col-12 sm:col-6 md:col-4 xl:col-3">
                            ...
                            <vue-select class="db-field-control f-b-custom-select" id="searchStatus"
                                v-model="props.search.status" :options="[
                                    ...
                                    { id: enums.orderStatusEnum.DELIVERED, name: $t('label.completed') },
                    ...
                    <tbody class="db-table-body" v-if="salesReports.length > 0">
                        <tr class="db-table-body-tr" v-for="salesReport in salesReports" :key="salesReport">
                            ...
                            <td class="db-table-body-td">
                                <span v-if="salesReport.transaction_payment_method">
                                    {{ salesReport.transaction_payment_method }}
                                </span>
                                <span v-else-if="salesReport.order_type === enums.orderTypeEnum.POS">
                                    {{ salesReport.pos_payment_method === 1 ? $t("label.cash") : $t("label.upi") }}
                                </span>
                                <span v-else>
    ...
    mounted() {
        ...
        this.$store.dispatch("paymentGateway/lists", {
            ...
            this.paymentGateways = [
                ...
                { id: -posPaymentMethodEnum.UPI, name: this.$t("label.upi") }
            ];
        })
    },
    computed: {
